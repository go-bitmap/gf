...
func (s *GrpcServer) SetMetadata(ctx context.Context, key string, value interface{}) {
	if s.registrar == nil {
		return
	}
	s.serviceMu.Lock()
...
func (s *GrpcServer) DelMetadata(ctx context.Context, key string) {
	if s.registrar == nil {
		return
	}
	s.serviceMu.Lock()
